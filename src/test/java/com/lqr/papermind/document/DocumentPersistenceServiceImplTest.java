...
import com.lqr.papermind.document.service.impl.DocumentPersistenceServiceImpl;
...
class DocumentPersistenceServiceImplTest {
    ...
    void replaceAssetsShouldAssignPrimaryKeyBeforeInsert() {
        com.lqr.papermind.common.model.DocumentAsset asset = new com.lqr.papermind.common.model.DocumentAsset(
                "asset-1",
                "source-1",
                0,
                "IMAGE",
        ...
        ArgumentCaptor<com.lqr.papermind.document.entity.DocumentAssetEntity> entityCaptor = ArgumentCaptor.forClass(com.lqr.papermind.document.entity.DocumentAssetEntity.class);
