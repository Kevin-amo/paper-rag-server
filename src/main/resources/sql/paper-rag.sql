...
insert into public.review_criterion (code, name, description, max_score, weight, version, category, evidence_required, scoring_rules, enabled, sort_order)
values
    ('POLICY', '政策导向', '检查论文是否存在政治不当表述、价值导向偏差或敏感风险。', 100, 20, 1, 'COMPLIANCE', true, '[{"level":"excellent","range":[90,100],"description":"无政治不当表述，价值导向明确，相关论述客观规范"},{"level":"good","range":[75,89],"description":"整体符合政策导向要求，个别表达建议进一步规范"},{"level":"review","range":[0,74],"description":"存在需要专家重点复核的政策导向或敏感表达风险"}]'::jsonb, true, 10),
    ('MATCH', '专业匹配', '判断研究主题、研究对象和方法路径是否符合申报方向或评审场景。', 100, 20, 1, 'RELEVANCE', true, '[{"level":"excellent","range":[90,100],"description":"研究主题、对象和方法与申报方向高度一致"},{"level":"good","range":[75,89],"description":"整体匹配申报方向，少量内容需要补充关联说明"},{"level":"review","range":[0,74],"description":"存在明显方向偏离或匹配依据不足，需专家复核"}]'::jsonb, true, 20),
    ('INNOVATION', '创新性', '评价选题、方法、数据、结论或应用场景是否具有新意。', 100, 20, 1, 'QUALITY', true, '[{"level":"excellent","range":[90,100],"description":"选题或方法具有明显创新点，论证充分且价值清晰"},{"level":"good","range":[75,89],"description":"具备一定创新性，但创新边界或贡献阐释可加强"},{"level":"review","range":[0,74],"description":"创新性不足或与已有研究区分不清，需重点复核"}]'::jsonb, true, 30),
    ('LOGIC', '逻辑性', '评价论文结构、论证链路、方法与结论之间的连贯性。', 100, 20, 1, 'QUALITY', true, '[{"level":"excellent","range":[90,100],"description":"结构清晰，论证链路完整，方法与结论一致"},{"level":"good","range":[75,89],"description":"整体逻辑连贯，局部章节衔接或论据支撑可优化"},{"level":"review","range":[0,74],"description":"存在论证断裂、前后矛盾或结论支撑不足风险"}]'::jsonb, true, 40),
    ('LANGUAGE', '语言质量', '评价表达准确性、学术规范性、语句流畅度和错别字风险。', 100, 20, 1, 'QUALITY', true, '[{"level":"excellent","range":[90,100],"description":"表达准确流畅，术语使用规范，未见明显语言问题"},{"level":"good","range":[75,89],"description":"整体表达规范，存在少量可编辑优化的问题"},{"level":"review","range":[0,74],"description":"语言错误较多或学术表达不规范，影响评审理解"}]'::jsonb, true, 50),
    ('REFERENCE', '参考文献规范', '检查参考文献格式、引用完整性和明显缺失问题。', 100, 10, 1, 'COMPLIANCE', true, '[{"level":"excellent","range":[90,100],"description":"参考文献格式统一，引用完整且与正文对应良好"},{"level":"good","range":[75,89],"description":"整体符合规范，存在少量格式或引用细节问题"},{"level":"review","range":[0,74],"description":"参考文献缺失、格式混乱或正文引用对应关系不足"}]'::jsonb, true, 60)
on conflict (code) do update set
    name = excluded.name,
    description = excluded.description,
